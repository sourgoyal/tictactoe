// Package main, code is generated by the swagger tool
// Handler Functions defined here manually in main(). Rest other code in this main.go is auto generated by go-swagger
package main
...
func main() {
	...
	// Package game, implements all below used methods.
	games := game.New()
