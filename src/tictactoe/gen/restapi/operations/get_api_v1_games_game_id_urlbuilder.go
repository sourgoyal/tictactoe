...
func (o *GetAPIV1GamesGameIDURL) WithBasePath(bp string) *GetAPIV1GamesGameIDURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetAPIV1GamesGameIDURL) Build() (*url.URL, error) {
	...
	if gameID != "" {
		...
		return nil, errors.New("gameId is required on GetAPIV1GamesGameIDURL")
	}
...
func (o *GetAPIV1GamesGameIDURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetAPIV1GamesGameIDURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetAPIV1GamesGameIDURL")
	}
