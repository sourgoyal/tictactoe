...
func (o *DeleteAPIV1GamesGameIDURL) WithBasePath(bp string) *DeleteAPIV1GamesGameIDURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *DeleteAPIV1GamesGameIDURL) Build() (*url.URL, error) {
	...
	if gameID != "" {
		...
		return nil, errors.New("gameId is required on DeleteAPIV1GamesGameIDURL")
	}
...
func (o *DeleteAPIV1GamesGameIDURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteAPIV1GamesGameIDURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteAPIV1GamesGameIDURL")
	}
